...
type GotItMerchantAPI interface {
	...
	*/
	CheckMultiple(ctx context.Context) ApiCheckMultipleRequest

	// CheckMultipleExecute executes the request
	//  @return ResponseCheckMultipleSchema
	CheckMultipleExecute(r ApiCheckMultipleRequest) (*ResponseCheckMultipleSchema, *http.Response, error)
	...
	*/
	Reserved(ctx context.Context) ApiReservedRequest

	// ReservedExecute executes the request
	//  @return ResponseReservedSchema
	ReservedExecute(r ApiReservedRequest) (*ResponseReservedSchema, *http.Response, error)
	...
	*/
	Unreserved(ctx context.Context) ApiUnreservedRequest

	// UnreservedExecute executes the request
	//  @return ResponseUnReservedSchema
	UnreservedExecute(r ApiUnreservedRequest) (*ResponseUnReservedSchema, *http.Response, error)
	...
	*/
	UseMultiple(ctx context.Context) ApiUseMultipleRequest

	// UseMultipleExecute executes the request
	//  @return ResponseMarkUseMultipleSchema
	UseMultipleExecute(r ApiUseMultipleRequest) (*ResponseMarkUseMultipleSchema, *http.Response, error)
}
