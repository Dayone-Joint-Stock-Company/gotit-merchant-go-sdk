...
// checks if the ResponseReservedSchemaUsedStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseReservedSchemaUsedStore{}

// ResponseReservedSchemaUsedStore Store marked voucher used/reserved
type ResponseReservedSchemaUsedStore struct {
...
func NewResponseReservedSchemaUsedStore() *ResponseReservedSchemaUsedStore {
	this := ResponseReservedSchemaUsedStore{}
	return &this
}
...
func (o ResponseReservedSchemaUsedStore) MarshalJSON() ([]byte, error) {
...
func (o ResponseReservedSchemaUsedStore) ToMap() (map[string]interface{}, error) {
...
type NullableResponseReservedSchemaUsedStore struct {
	value *ResponseReservedSchemaUsedStore
	isSet bool
}

func (v NullableResponseReservedSchemaUsedStore) Get() *ResponseReservedSchemaUsedStore {
	return v.value
}

func (v *NullableResponseReservedSchemaUsedStore) Set(val *ResponseReservedSchemaUsedStore) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseReservedSchemaUsedStore) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseReservedSchemaUsedStore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseReservedSchemaUsedStore(val *ResponseReservedSchemaUsedStore) *NullableResponseReservedSchemaUsedStore {
	return &NullableResponseReservedSchemaUsedStore{value: val, isSet: true}
}

func (v NullableResponseReservedSchemaUsedStore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseReservedSchemaUsedStore) UnmarshalJSON(src []byte) error {
	v.isSet = true
