...
// checks if the RequestCheckMultipleBodySchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestCheckMultipleBodySchema{}

// RequestCheckMultipleBodySchema struct for RequestCheckMultipleBodySchema
type RequestCheckMultipleBodySchema struct {
	// Store pin
...
func NewRequestCheckMultipleBodySchema() *RequestCheckMultipleBodySchema {
	this := RequestCheckMultipleBodySchema{}
	return &this
}
...
func (o RequestCheckMultipleBodySchema) MarshalJSON() ([]byte, error) {
...
func (o RequestCheckMultipleBodySchema) ToMap() (map[string]interface{}, error) {
...
type NullableRequestCheckMultipleBodySchema struct {
	value *RequestCheckMultipleBodySchema
	isSet bool
}

func (v NullableRequestCheckMultipleBodySchema) Get() *RequestCheckMultipleBodySchema {
	return v.value
}

func (v *NullableRequestCheckMultipleBodySchema) Set(val *RequestCheckMultipleBodySchema) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestCheckMultipleBodySchema) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestCheckMultipleBodySchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestCheckMultipleBodySchema(val *RequestCheckMultipleBodySchema) *NullableRequestCheckMultipleBodySchema {
	return &NullableRequestCheckMultipleBodySchema{value: val, isSet: true}
}

func (v NullableRequestCheckMultipleBodySchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestCheckMultipleBodySchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
